...
<html lang="nl">
    ...
    <body onload="startInit();">
        ...
        <div style="padding: 16px 8px; width: 400px; max-width: 80%; margin: 0 auto; text-align: center;"><a href="/routeplanner/">Terug naar de standaardversie van de Routeplanner</a></div>
        <form id="routeform">
            <table>
                <tr>
                    <th>Van</th>
